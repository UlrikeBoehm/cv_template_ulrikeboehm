...
\cfoot{Page \thepage \hspace{1pt} of 7}
...
\begin{list2}
\vspace*{-1mm}
\item Handling and troubleshooting of  advanced instruments (iPALM, Lattice Light Sheet Microscope, SiMView Light Sheet Microscope, Aberration Corrected Multifocal Microscope, MOSAIC, FIB-SEM, cryo-SIM, etc), sample preparation and image analysis
...
\item Review of AIC proposals and grants
...
Janelia Research Campus, Ashburn, United States of America\\
\vspace*{-3mm}\\
{\bf  Mentoring for Postbac Students} \hfill 2020-present\\
...
\vspace*{-3mm}\\
{\bf Janelia \& EMBL Optical Interest  Group Seminar Series}, Co-organizer \hfill {2020 - present}\\
Ashburn, United States of America\\
\vspace*{-3mm}\\
...
{\bf Data Analysis for Social Scientists} \hfill {2020}\\
\vspace*{-3.5mm}
\begin{addmargin}[0pt]{.1\linewidth}
\vspace*{-1mm}
...
{\bf Probability - The Science of Uncertainty and Data} \hfill {2020}\\
\vspace*{-3.5mm}
\begin{addmargin}[0pt]{.1\linewidth}
\vspace*{-1mm}
