...
%\item Design and development of hardware and software for advanced instrumentation
...
\href{https://www.janelia.org/}{Janelia Research Campus}, \href{https://www.aicjanelia.org/}{Advanced Imaging Center}, Ashburn, VA, USA\\
 \vspace*{-1mm}
%\begin{addmargin}[0pt]{.15\linewidth}
\begin{list2}
\vspace*{-1mm}
...
\item Analysis of Multi-SANS data (with MIRA) and data of Cytochrom C (with the Neutron Spin Echo RESEDA) at the FRM II – “research reactor Munich II”, Munich, Germany - Dr Robert Georgii and Prof Peter Böni (2007)
...
\item Performance evaluation of an animal PET scanner at the university hospital "Rechts der Isar", Munich, Germany - Prof Sibylle Ziegler(2006)
...
{\bf Virtual Janelia / EMBL OIG Seminar Series}, Co-organizer \hfill {2020 - present}\\
...
San Francisco, United States of America\\
\vspace*{-3mm}\\
{\bf QUAREP-LiMi}, Vice-chair of the working groups for image quality \hfill {2020 - present}\\
\vspace*{-3mm}\\
